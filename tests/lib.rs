...
// copied from https://github.com/rustls/tokio-rustls/blob/main/tests/utils.rs
...
fn regenerate_certs() {
    ...
    let mut end_entity_params = CertificateParams::new(vec!["localhost".to_string()]).unwrap();
